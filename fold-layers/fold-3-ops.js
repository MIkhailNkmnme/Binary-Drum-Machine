...
alignBtns.forEach(btn => {
  btn.onclick = () => {
    ...
    /* ПОД ЗАМКОМ (🔒) полоса, направленная на П1/П2, ничего им не делает. Это
    ...
    if (typeof alignTarget !== "undefined" && alignTarget !== "C" && !isAxisAlign(nextAlign)
      ...
      say("🔒 Замок — полоса выравниваний сейчас направлена на " + (alignTarget === "L" ? "П1" : "П2") + ", а под замком колонки паттернов заперты. Переключите приёмник на «Ц» или снимите замок (🔓).");
      return;
    }
