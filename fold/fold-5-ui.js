...
if (bAlignPatLEl) bAlignPatLEl.onclick = () => cyclePatAlign("l");
...
function makeColResizer(el, varName, selectorOfCol, minPx, onManual){
  if (!el) return;
  el.addEventListener("mousedown", e => {
